// Code generated by "stringer -type AuthTransformId,DhTransformId,EncrTransformId,IdType,IkeExchangeType,NotificationType,PrfTransformId -output protocol_strings.go"; DO NOT EDIT
